...
# web application at http://savelink.pythonanywhere.com/
...
# assuming your django settings file is at '/home/savelink/mysite/mysite/settings.py'
# and your manage.py is is at '/home/savelink/mysite/manage.py'
path = '/savelink'
if path not in sys.path:
    sys.path.append(path)

os.environ['DJANGO_SETTINGS_MODULE'] = 'savelink.settings'
...
#import sys
#
## The "/home/savelink" below specifies your home
## directory -- the rest should be the directory you uploaded your Flask
## code to underneath the home directory.  So if you just ran
## "git clone git@github.com/myusername/myproject.git"
## ...or uploaded files to the directory "myproject", then you should
## specify "/home/savelink/myproject"
#path = '/home/savelink/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
